...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(FileWork.count("E:/Java/JavaSchool/WordInFile/src/test.txt"));
            System.out.println(" ");
